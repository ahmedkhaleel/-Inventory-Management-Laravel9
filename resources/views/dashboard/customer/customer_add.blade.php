                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('customer.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="address" id="address" class="form-control" placeholder="Enter Supplier Address">
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <img id="showImage" class="rounded avatar-lg" src="{{(!empty($adminData->profile_image)) ? url('upload/customer_image/'.$adminData->profile_image) : url('upload/no_image.png') }}" width="75" height="75" alt="Card image cap">
                            </div>
                        </div>
