...
@section('content')
                    ...
                    <div class="tab nav-border" style="position: relative;">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="months" role="tabpanel" aria-labelledby="months-tab">
                                ...
                                <div class="row mb-20">
                                    <div class="col-md-2 col-sm-6">
                                        <img class="img-fluid" src="{{asset('admin/dashboard/images/blog/03.jpg')}}" alt="">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-6">
                                        <img class="img-fluid" src="{{asset('admin/dashboard/images/blog/04.jpg')}}" alt="">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                            ...
                            <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                <div class="row mb-20">
                                    <div class="col-md-2 col-sm-6">
                                        <img class="img-fluid" src="{{asset('admin/dashboard/images/blog/09.jpg')}}" alt="">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                ...
                                <div class="row mb-20">
                                    <div class="col-md-2 col-sm-6">
                                        <img class="img-fluid" src="{{asset('admin/dashboard/images/blog/06.jpg')}}" alt="">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                ...
                                <div class="row mb-20">
                                    <div class="col-md-2 col-sm-6">
                                        <img class="img-fluid" src="{{asset('admin/dashboard/images/blog/07.jpg')}}" alt="">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-md-2 col-sm-6">
                                        <img class="img-fluid" src="{{asset('admin/dashboard/images/blog/08.jpg')}}" alt="">
                                    </div>
                                    <div class="col-md-6 col-sm-6">
    ...
    <div class="row">
                        ...
                        <li class="mb-20">
                            <div class="d-flex">
                                <div class="position-relative">
                                    <img class="img-fluid mr-15 avatar-small" src="{{asset('admin/dashboard/images/item/01.png')}}" alt="">
                                </div>
                        ...
                        <li class="mb-20">
                            <div class="d-flex">
                                <div class="position-relative clearfix">
                                    <img class="img-fluid mr-15 avatar-small" src="" alt="">
                                </div>
                                <div class="ms-3 w-100">
        ...
        <div class="col-xl-4 mb-20">
            <div class="card card-statistics h-100">
                <div class="p-4 text-center bg" style="background: {{asset('admin/dashboard/images/bg/01.jpg')}};">
                ...
                <div class="card-body text-center position-relative">
                    <div class="avatar-top">
                        <img class="img-fluid w-25 rounded-circle " src="{{asset('admin/dashboard/images/team/13.jpg')}}" alt="">
                    </div>
                    <div class="row">
